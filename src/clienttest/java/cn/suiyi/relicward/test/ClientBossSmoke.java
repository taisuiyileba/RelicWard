...
public final class ClientBossSmoke {
    ...
    @SubscribeEvent public static void tick(TickEvent.ClientTickEvent e){
        if(e.phase!=TickEvent.Phase.END||!Boolean.getBoolean("relicward.bossSmoke"))return;var mc=Minecraft.getInstance();if(failure!=null)throw new RuntimeException(failure);
        if(stage==0&&mc.screen instanceof TitleScreen&&mc.getOverlay()==null){
            ...
            ticks++;
            if(ticks==60){capture="boss082_phase_one";checkMusic(1);}
            ...
            if(ticks==210){capture="boss082_phase_two";checkMusic(2);}
            ...
            if(ticks==300){
                ...
                LogUtils.getLogger().info("RELICWARD_BOSS_SMOKE_OK: both phase tracks active, HUD screenshots, reset stops music");mc.stop();stage=4;
            }
        }
    }
